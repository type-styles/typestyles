...
const sidebarBase = styles.component('docs-sidebar', {
  root: {
    ...
    borderRight: `4px solid ${t.color.border.default}`,
  ...
  searchWrapper: {
    position: 'relative',
    // margin: `0 ${t.space[4]} ${t.space[4]}`,
    borderTop: `4px solid ${t.color.border.default}`,
    borderBottom: `4px solid ${t.color.border.default}`,
  },
  searchIcon: {
    position: 'absolute',
  ...
  searchInput: {
    ...
    fontSize: t.fontSize.sm,
    fontFamily: t.fontFamily.sans,
    border: `4px solid ${t.color.border.default}`,
    color: t.color.text.secondary,
    outline: 'none',
    transition: 'border-color 0.15s ease, background-color 0.2s ease',
    '&:focus': { borderColor: t.color.accent.default },
  ...
  searchKbd: {
    ...
    boxShadow: `1px 1px 0 2px ${t.color.border.default}`,

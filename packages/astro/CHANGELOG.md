...
- [#39](https://github.com/dbanksdesign/typestyles/pull/39): Add **`@typestyles/astro`**, an Astro integration that registers the existing `@typestyles/vite` plugin for dev HMR and optional build-time CSS extraction (`mode` / `extract` options re-exported from the Vite plugin).
...
- Updated dependencies [[#60](https://github.com/dbanksdesign/typestyles/pull/60)]

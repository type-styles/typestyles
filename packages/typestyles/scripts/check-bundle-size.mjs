...
const INDEX_GZIP_BUDGET = 21_700; // +~1000B for mode: 'bem' (BEM class-name builders, modifier-collision dev warning) and the mode: 'attribute' relocation (new createStyles/createTypeStyles overloads, shared selector-key merging)

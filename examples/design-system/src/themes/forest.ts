...
const forestLightColorValues: DesignColorValues = {
  background: { app: p.palette['sage-1'], surface: p.palette['neutral-1'], subtle: p.palette['sage-2'], elevated: p.palette['neutral-1'] },
  text: { primary: p.palette['sage-10'], secondary: p.palette['sage-7'], onAccent: p.palette['neutral-1'], onDanger: p.palette['neutral-1'] },
  accent: { default: p.palette['green-7'], hover: p.palette['green-8'] },
  border: { default: p.palette['sage-4'], strong: p.palette['sage-6'], focus: p.palette['green-5'] },
...
const forestDarkColorValues: DesignColorValues = {
  background: { app: color.oklch('12%', 0.03, 165), surface: p.palette['sage-9'], subtle: p.palette['sage-8'], elevated: p.palette['sage-9'] },
  text: { primary: p.palette['sage-1'], secondary: p.palette['sage-3'], onAccent: p.palette['neutral-1'], onDanger: p.palette['neutral-1'] },
  accent: { default: p.palette['green-4'], hover: p.palette['green-3'] },
  border: { default: p.palette['sage-7'], strong: p.palette['sage-6'], focus: p.palette['green-4'] },

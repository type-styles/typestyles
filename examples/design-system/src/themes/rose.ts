...
const roseLightColorValues: DesignColorValues = {
  background: { app: p.palette['rose-1'], surface: p.palette['neutral-1'], subtle: p.palette['rose-2'], elevated: p.palette['neutral-1'] },
  text: { primary: p.palette['rose-10'], secondary: p.palette['rose-7'], onAccent: p.palette['neutral-1'], onDanger: p.palette['neutral-1'] },
...
const roseDarkColorValues: DesignColorValues = {
  background: { app: color.oklch('12%', 0.03, 355), surface: p.palette['rose-9'], subtle: p.palette['rose-8'], elevated: p.palette['rose-9'] },
  text: { primary: p.palette['rose-1'], secondary: p.palette['rose-3'], onAccent: p.palette['neutral-1'], onDanger: p.palette['neutral-1'] },
